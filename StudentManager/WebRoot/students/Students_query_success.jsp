...
<script type="text/javascript">
	function findsid(){
		var value_1 = document.getElementById("text1");
		sid=propmpt("请输入学号查找：");
		value_1.innerHTML=sid;
	}
</script>
...
<table class="default" width="100%">
	...
	<tr class="list">
		...
		<td><a href="<%=path%>/students/Students_show.action?sid=<s:property value="#stu.sid"/>"><s:property value="#stu.sname"/></a></td>
